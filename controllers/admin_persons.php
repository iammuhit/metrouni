...
/**
 * Metrouni Person Controller Class
 * 
 ...
 */
class Admin_Persons extends Admin_Controller {

    protected $section = 'persons';
    ...
    public function index() {
        ...
        $pagination = create_pagination('admin/metrouni/persons/index', $this->user_m->count_by($base_where));
        ...
        $this->template
                ...
                ->set('users', $users)
                ->set_partial('filters', 'admin/persons/partials/filters')
                ->append_js('admin/filter.js');

        $this->input->is_ajax_request() ? $this->template->build('admin/persons/tables/users') : $this->template->build('admin/persons/index');
    }
    ...
    public function create() {
        ...
        if ($this->form_validation->run() !== false) {
            ...
            if ($user_id = $this->ion_auth->register($username, $password, $email, $group_id, $profile_data, $group->name)) {
                ...
                redirect('admin/metrouni/persons');
            }
            // Error
            else {
...
/* End of file admin_persons.php */
/* Location: ./modules/metrouni/controllers/admin_persons.php */