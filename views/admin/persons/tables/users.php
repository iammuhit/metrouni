                ...
                <tr>
                    ...
                    <td>
                        <?php if ($link_profiles) : ?>
                            <?php echo anchor('admin/metrouni/persons/preview/' . $member->id, $member->display_name, 'target="_blank" class="modal-large"'); ?>
                        <?php else: ?>
                    ...
                    <td class="actions">
                        <?php echo anchor('admin/metrouni/persons/edit/' . $member->id, lang('global:edit'), array('class' => 'button edit')); ?>
                        <?php echo anchor('admin/metrouni/persons/delete/' . $member->id, lang('global:delete'), array('class' => 'confirm button delete')); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
